...
public class LoginActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(task -> {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (user != null && user.isEmailVerified()) {
                                ...
                                boolean isOtpStillValid = (System.currentTimeMillis() - lastOtp) < OTP_VALID_DURATION;
    ...
    private void generateAndSendOTP(String email) {
        ...
        sharedPreferences.edit().putLong(KEY_LAST_OTP_VERIFIED, 0).apply(); // force OTP
        ...
        finish(); // prevent going back and skipping OTP
    }
